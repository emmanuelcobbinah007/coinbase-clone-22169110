          ...
          <form onSubmit={handleContinue} className="flex flex-col gap-4">
            {step === 'email' ? (
              ...
              <>
                ...
                <Link to="/forgot-password" className="text-blue-400 text-sm hover:underline w-fit mt-1">
                  Forgot password?
                </Link>
              </>
            )}
            ...
            >
              {step === 'password' && isLoading ? 'Signing in...' : 'Continue'}
            </button>
          ...
          {step === 'email' && (
            <>
              ...
              <div className="flex flex-col gap-3">
                {[
                  { label: 'Sign in with Passkey', icon: (
                  ...
                  { label: 'Sign in with Google', icon: (
